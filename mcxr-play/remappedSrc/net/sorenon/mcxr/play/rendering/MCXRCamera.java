...
public class MCXRCamera extends Camera {
    ...
    public void setPose(Pose pose) {
        ...
        this.getRotation().hamiltonProduct(net.minecraft.util.math.Vec3f.POSITIVE_Y.getDegreesQuaternion(-pose.getMCYaw()));
        this.getRotation().hamiltonProduct(net.minecraft.util.math.Vec3f.POSITIVE_X.getDegreesQuaternion(pose.getMCPitch()));
