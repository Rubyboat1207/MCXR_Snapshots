    ...
    public void onInitializeClient() {
        ...
        WorldRenderEvents.AFTER_ENTITIES.register(context -> {
            if (MCXR_GAME_RENDERER.renderPass instanceof RenderPass.XrWorld) {
                if (!MinecraftClient.getInstance().options.hudHidden && !MCXRGuiManager.isScreenOpen()) {
                    ...
                    if (hitResult != null && !this.MCXRGuiManager.isScreenOpen()) {
                        ...
                        RenderLayer cursorLayer = RenderLayer.getEntityCutoutNoCull(GUI_ICONS_TEXTURE);
